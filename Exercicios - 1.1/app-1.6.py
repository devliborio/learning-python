...
if n1 and n2 and nr:
    ...
    cAlternative = nr**3
    print("A - O resultado do produto do dobro do primeiro com a métade do segundo é: {}".format(aAlternative))
    print("B - O resultado da soma do triplo do primeiro com o terceiro é: {}".format(bAlternative))
